...
public class GameWorld implements Disposable {
	...
	public GameWorld(IncanShift game, Viewport viewport, Vector3 screenCenter,
		...
		levels = new LevelData[]{
				...
				new LevelData(false, "model/inside_level2_jump_and_shoot.csv", "sound/roomchange.ogg", "sound/mask_v2.ogg"),
				new LevelData(false, "model/inside_level3_path_with_masks.csv", "sound/roomchange.ogg", "sound/mask_v2.ogg"),
				new LevelData(false, "model/inside_level4_throw_out_the_bodies.csv", "sound/roomchange.ogg", "sound/mask_v2.ogg"),
				...
				new LevelData(true, "model/inside_level7_three_levels.csv", "sound/roomchange.ogg", "sound/bossmusic_2.ogg"),
				new LevelData(true, "model/inside_level8_3d_space.csv", "sound/roomchange.ogg", "sound/bossmusic_2.ogg"),
				new LevelData(true, "model/inside_level9_ant_hive.csv", "sound/roomchange.ogg", "sound/bossmusic_2.ogg"),
				new LevelData(true, "model/inside_level10_inside_the_temple.csv", "sound/roomchange.ogg", "sound/swamp.ogg"),
				new LevelData(true, "model/inside_level11_pillars_in_a_hill_of_stairs.csv", "sound/roomchange.ogg", "sound/swamp.ogg"),
				...
				new LevelData(false, "model/inside_level14_well.csv", "sound/roomchange.ogg", "sound/silence.ogg"),
		};
